...
class DynamicalModel(nn.Module):
    def __init__(
        ...
        self.config = config
        # `components` defines which network heads exist in the model. This is a
        # model-architecture choice, separate from conditional-path semantics
        # and separate from stage-level `train_strategy`.
